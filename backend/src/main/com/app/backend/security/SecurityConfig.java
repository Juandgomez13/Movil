...
public class SecurityConfig {
    ...
    public AuthenticationManager authenticationManager(AuthenticationConfiguration authConfig) throws Exception{
        return authConfig.getAuthenticationManger();
    }
    ...
    public DaoAuthenticationProvider authenticationProvider() {
        ...
        authProvider.setPasswordEndcoder(passwordEncoder());
    ...
    Exception{
        http
            ...
            .AuthorizeHttpRequest(auht -> auth
                ...
                http.addFilterBefore(jwtAuthenticationFilter, beforeFilter: UsernamePasswordAuthenticationFilter
                .class);
