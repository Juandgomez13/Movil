                ...
                ListEmptyComponent={
                    !loading && !error ? (
                        <View style={categoriesStyles.emptyContainer}>
                            <Text style={categoriesStyles.emptyText}>No hay categorías.</Text>
                    ...
                    <View style={categoriesStyles.modalContent}>
                        <ScrollView>
                            ...
                            <View style={categoriesStyles.modalButtons}>
                                ...
                                onPress={handleSave}>
                                    <Text style={[categoriesStyles.modalButtonText, categoriesStyles.saveButtonText]}>{editing ? 'Actualizar' : 'Crear'}</Text>
                                </TouchableOpacity>
                            </View>
                        </ScrollView>
                    </View>
